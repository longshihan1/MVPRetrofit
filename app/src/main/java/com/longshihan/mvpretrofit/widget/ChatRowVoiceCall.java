package com.longshihan.mvpretrofit.widget;
    ...
    protected void onInflateView() {
        if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VOICE_CALL, false)){
            inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
                    com.hyphenate.easeui.R.layout.ease_row_received_voice_call : com.hyphenate
                    .easeui.R.layout.ease_row_sent_voice_call, this);
        // video call

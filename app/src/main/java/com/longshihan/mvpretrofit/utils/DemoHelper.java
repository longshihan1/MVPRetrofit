...
import com.longshihan.mvpretrofit.bean.db.DemoDBManager;
...
import com.longshihan.mvpretrofit.parse.UserProfileManager;
import com.longshihan.mvpretrofit.receiver.CallReceiver;
...
public class DemoHelper {
    ...
    public void init(Context context) {
        ...
        if (EaseUI.getInstance().init(context, options)) {
            ...
            EMClient.getInstance().callManager().getCallOptions().setIsSendPushIfOffline(getModel
                    ().isPushCall());
    ...
    private EMOptions initChatOptions() {
        ...
        if (demoModel.isCustomServerEnable() && demoModel.getRestServer() != null && demoModel
                .getIMServer() != null) {
        ...
        if (demoModel.isCustomAppkeyEnabled() && demoModel.getCutomAppkey() != null && !demoModel
                .getCutomAppkey().isEmpty()) {
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                if (user != null) {
                    if (EaseAtMessageHelper.get().isAtMeMsg(message)) {
                        return String.format(appContext.getString(R.string.at_your_in_group),
                                user.getNick());
                    }
    ...
    protected void setGlobalListeners() {
        ...
        connectionListener = new EMConnectionListener() {
            ...
            public void onConnected() {
                // in case group and contact were already synced, we supposed to notify sdk we
                // are ready to receive the events
    ...
    public void registerGroupAndContactListener() {
        if (!isGroupAndContactListenerRegisted) {
            EMClient.getInstance().groupManager().addGroupChangeListener(new
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationAccepted(String groupId, String invitee, String reason) {
            ...
            Log.d(TAG, invitee + "Accept to join the group：" + _group == null ? groupId : _group
                    .getGroupName());
                ...
                for (EMMessage message : messages) {
                   ...
                   /* if(!easeUI.hasForegroundActivies()){
                        if (action.equals(RPConstant.REFRESH_GROUP_RED_PACKET_ACTION)){
                            ...
                            broadcastManager.sendBroadcast(new Intent(RPConstant
                    ...
                    EMLog.d(TAG, String.format("Command：action:%s,message:%s", action, message
                            .toString()));
                }
            }

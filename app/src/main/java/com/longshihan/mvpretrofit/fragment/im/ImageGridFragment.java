...
import com.longshihan.mvpretrofit.BuildConfig;
import com.longshihan.mvpretrofit.R;
import com.longshihan.mvpretrofit.domain.VideoEntity;
import com.longshihan.mvpretrofit.utils.util.ImageCache;
import com.longshihan.mvpretrofit.utils.util.ImageResizer;
import com.longshihan.mvpretrofit.utils.util.Utils;
import com.longshihan.mvpretrofit.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			intent.setClass(getActivity(), com.longshihan.mvpretrofit.activity.im.RecorderVideoActivity.class);
